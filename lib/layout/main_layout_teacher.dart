...
class _MainLayoutTeacherState extends State<MainLayoutTeacher> {
  ...
  @override
  void initState() {
    attendance = Attendance(id: 0, studentId: 0, medicalCenterId: 0, student: Student(id: 0, studentCode: "", teacherId: 0, user: User(id: 0, firstName: "", lastName: "")), medicalcenter: MedicalCenter(id: 0, name: ""), status: '', date: DateTime.now());
    super.initState();
    _pages = [
